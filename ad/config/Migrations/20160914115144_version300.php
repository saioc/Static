    ...
    public function up()
    {
        ...
        $this->table('statistics')
            ...
            ->changeColumn('reason', 'integer', [
                'comment' => '1=Earn, 2=Disabled cookie, 3=Anonymous user, 4=Adblock, 5=Proxy, 6=IP changed, 7=Not unique, 8=Full weight, 9=Default campaign, 10=direct',
                'default' => 0,
                'limit' => 10,
                'null' => false,
                'signed' => false
        ...
        $this->table('campaigns')
            ->changeColumn('status', 'integer', [
                'comment' => '1=Active, 2=Paused, 3=Canceled, 4=Finished, 5=Under Review, 6=Pending Payment, 7=Invalid Payment, 8=Refunded',
                'default' => 0,
                'limit' => 2,
                'null' => false,
                'signed' => false
