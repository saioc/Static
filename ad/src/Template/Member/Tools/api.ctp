...
<div class="box box-primary">
    <div class="box-body">
        ...
        <p><?= __('If you want a TEXT reposnse just add <b>&format=text</b> at the end of your request as ' .
        ...
        <div class="well">
            $api_url = "<?= $this->Url->build('/', true); ?>api/?api=<b><?= $user->api_token ?></b>&url=<b><?= urlencode('yourdestinationlink.com') ?></b>&alias=<b>CustomAlias</b>";<br>
        ...
        <div class="well">
            $api_url = "<?= $this->Url->build('/', true); ?>api/?api=<b><?= $user->api_token ?></b>&url=<b><?= urlencode('yourdestinationlink.com') ?></b>&alias=<b>CustomAlias</b>&format=<b>text</b>";<br>
