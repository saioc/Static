    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-2 text-center">
                <img alt="<?= h($link->title); ?>QR code" src="//bshare.optimix.asia/barCode?site=weixin&url=<?= urlencode(get_short_url($link->alias,  $link->domain)); ?>&mhid=s0rOCFvpmswhMHcqItxQP6g">
            </div>
        </div>
    </div>
</div>
