    ...
    public function __construct()
    {
        try {
            ...
            try {
                ...
                $theme_top_bar_color = $settings['theme_tone'] == 'dark' ? 'black' : 'white';
                $settings['theme_top_bar_color'] = $theme_top_bar_color;
                $defaults['theme_top_bar_color'] = $theme_top_bar_color;
